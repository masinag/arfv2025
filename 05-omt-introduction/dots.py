from pysmt.shortcuts import GE, LE, And, Equals, Int, Ite, Plus, Solver, Symbol
...
xx = [[Symbol(f"x{i}{j}", INT) for j in range(len(grid[0]))] for i in range(len(grid))]
